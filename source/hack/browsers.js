...
(function (factory) {
	...
	(function () {
		exports.data.css.properties.push(
			{

				"name": "background-click-color",
				"desc": "The property is only for bridge.",
				"browsers": "",
				"restriction": "enum, color",
				"values": [
					{
