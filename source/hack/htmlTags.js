...
(function (factory) {
    ...
    // bbuilderhack add by nandy007 @ 20170504 start
    (function () {
        ...
        var buiTags = {
            ...
            text: {},
            line: {
                attrs: ['direction:buidirection']
            },
            progress: {
                attrs: ['type:buiprocesstype', 'progress']
            },
            image: {
                attrs: ['src', 'defaultSrc']
            },
            textinput: {
                attrs: ['type:buitextinputtype',
                    'keyboardType:buikeyboardType',
                    'capitalize:buicapitalize',
                    'autoCorrect:b', 'prompt', 'maxLength',
                    'returnKeyType:buireturnKeyType',
                    'disabled:b', 'clearButtonMode:buiclearButtonMode']
            },
            textarea: {
                attrs: ['rows', 'keyboardType:buikeyboardType', 'capitalize:buicapitalize',
                    'autoCorrect:b', 'prompt', 'maxLength',
                    'returnKeyType:buireturnKeyType',
                    'disabled:b', 'clearButtonMode:buiclearButtonMode']
            },
            scroll: {
                attrs: ['direction:buidirection', 'scrollbar:b', 'bottomDistance', 'scrollToTop:b',
                    'bounces:b']
            },
            refresh: {
                attrs: ['type:buirefreshtype', 'distance']
            },
            list: {
                attrs: ['bottomDistance', 'scrollToTop:b']
            },
            cell: {},
            grid: {
                attrs: ['col']
            ...
            slider: {
                attrs: ['index', 'direction:buidirection', 'drag:b', 'loop:b', 'autoPlay:b', 'interval', 'bounces:b']
            },
            iconfont: {},
            video: {
                attrs: ['src', 'defaultSrc']
            ...
            webview: {
                attrs: ['url', 'bridge:b', 'zoom:b', 'checkSsl:b', 'progress:b', 'bounces:b']
            },
            handsign: {},
            baidumap: {
                attrs: ['maptype:buibaidumapmaptype', 'traffic:b', 'gesture:b', 'zoom:b', 'zoomLevel', 'scroll:b',
                    'rotate:b', 'rotateNumber', 'overLook:b', 'overLookNumber', 'mapPoi:b',
                    'scaleControl:b', 'zoomControl:b']
            },
            module: {},
            rlyimchat: {},
            rlyimgroupchat: {},
            ...
            linechart: {},
            barchart: {
                attrs: ['type:buibarcharttype']
            },
            combinedchart: {},
            candlechart: {},
            safetextfield: {
                attrs: ['name', 'keyboardType:buikeyboardType2', 'prompt', 'value', 'maxLength', 'disabled:b', 'clearButtonMode:buiclearButtonMode', 'sipreturntext', 'sipspacetext']
            },
            photoview: {
                attrs: ['defaultSrc']
            },
            basiclist: {
                attrs: ['scrollToTop:b', 'bottomDistance', 'type:buibasiclisttype', 'slideState:buislideState']
            }
        };

        for (var k in buiTags) {
            var tag = buiTags[k];
            HTML_TAGS[k] = new HTMLTagSpecification(localize('tags.' + k, tag.desc || ('The ' + k + ' element is only for bridge.')), tag.attrs || []);
        }
    ...
    function getHTML5TagProvider() {
        ...
        (function () {
            var valSet = {
                buibaidumapmaptype: ['normal', 'satellite'],
                buirefreshtype: ['top', 'bottom'],
                buiclearButtonMode: ['never', 'whileEditing', 'unlessEditing', 'always'],
                buireturnKeyType: ['default', 'go', 'search', 'next', 'send'],
                buicapitalize: ['characters', 'words', 'sentences'],
                buikeyboardType: ['default', 'number', 'phone', 'decimal', 'phone', 'email', 'url'],
                buitextinputtype: ['text', 'password'],
                buidirection: ['horizontal', 'vertical'],
                buiprocesstype: ['circle', 'pie', 'water'],
                buibarcharttype: ['vertical', 'horizontal'],
                buikeyboardType2: ['default', 'number'],
                buibasiclisttype: ['normal', 'slide'],
                buislideState: ['0', '1']
            };

            for (var k in valSet) {
                valueSets[k] = valSet[k];
            }

        })();

        (function () {
            globalAttributes.push('v-text', 'v-html', 'v-for', 'v-filter', 'v-on:eventName', 'v-one:eventName', 'v-bind:attributeName', 'v-style', 'v-class', 'v-show', 'v-if', 'v-elseif', 'v-else', 'v-model', 'v-like');
        })();
        // bbuilderhack end
